...
QUESTIONS = {
    ...
    "repair": [
        {"question": "Что именно ремонтируем?",
         "options": ["Производственное оборудование", "Офисная техника", "Инженерные системы", "Транспортные средства"]},
...
class TenderAgent:
    ...
    async def generate_criteria(self) -> str:
        ...
        system = (
            ...
            f"{examples}\n"
            f"Составь критерии допуска участников к закупке.\n"
