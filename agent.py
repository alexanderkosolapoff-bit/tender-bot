...
class TenderAgent:
    ...
    async def generate_criteria(self) -> str:
        ...
        system = (
            f"Ты эксперт по закупкам. Составляешь документ 'Критерии допуска участников'.\n\n"
            f"{examples}\n"
            f"Составь критерии допуска. Для каждого критерия используй строго формат:\n"
            ...
            f"Только список, без заголовков."
        )
